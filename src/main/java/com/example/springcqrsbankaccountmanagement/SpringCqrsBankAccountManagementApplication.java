package com.example.springcqrsbankaccountmanagement;

import com.example.springcqrsbankaccountmanagement.commands.aggregates.AccountAggregate;
...
public class SpringCqrsBankAccountManagementApplication {

  public static void main(String[] args) {
    SpringApplication.run(SpringCqrsBankAccountManagementApplication.class, args);
  }
